                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p>{{Str::words(strip_tags($featured_job->description),5)}}</p>
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{route('job.detail',$featured_job->id)}}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p>{{Str::words(strip_tags($latest_job->description),5)}}</p>
                                    <div class="bg-light p-3 border">
                                        <p class="mb-0">
                                            <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{route('job.detail',$latest_job->id)}}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
