                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr id="job-application-{{ $jobApplication->id }}">
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{ route('job.detail', $jobApplication->job_id) }}"><i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                    <li>
                                                        <!-- Use a button for form submission -->

                                                            <a  class="dropdown-item" onclick="removeJob({{$jobApplication->id}})"><i class="fa fa-trash" aria-hidden="true"></i> Remove</a>
                            ...
                            {{ $jobApplications->links() }} <!-- Pagination links -->
...
<script type="text/javascript">
    function removeJob(id) {
        if (confirm("Are you sure you want to remove this job application?")) {
            $.ajax({
                url: '{{ route("job.removeJobApplications") }}',
                type: 'POST',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        alert('Failed to remove job application. Please try again.');
                    }
                },
