                        ...
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr id="job-application-{{ $savedJob->id }}">
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{ route('job.detail', $savedJob->job_id) }}"><i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                    <li>
                                                        <!-- Use a button for form submission -->

                                                            <a  class="dropdown-item" onclick="removeSavedJob({{$savedJob->id}})"><i class="fa fa-trash" aria-hidden="true"></i> Remove</a>
